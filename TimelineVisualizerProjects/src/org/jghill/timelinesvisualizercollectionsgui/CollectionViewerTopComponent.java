...
public final class CollectionViewerTopComponent extends TopComponent implements ExplorerManager.Provider {

    private transient ExplorerManager explorerManager = new ExplorerManager();
    
    public CollectionViewerTopComponent() {
        initComponents();
        ...
        //explorerManager.setRootContext(new AbstractNode(new Collection()))
    }
